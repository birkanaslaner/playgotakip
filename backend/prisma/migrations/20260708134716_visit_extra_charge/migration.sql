...
INSERT INTO "new_Visit" ("amount", "checkInAt", "checkOutAt", "childId", "createdAt", "discount", "durationMin", "extraMinutes", "guardianId", "id", "membershipEndAt", "membershipMonths", "pausedAt", "pausedMs", "paymentMethod", "paymentStatus", "pricingPlanId", "staffId", "wristbandNo") SELECT "amount", "checkInAt", "checkOutAt", "childId", "createdAt", "discount", "durationMin", "extraMinutes", "guardianId", "id", "membershipEndAt", "membershipMonths", "pausedAt", "pausedMs", "paymentMethod", "paymentStatus", "pricingPlanId", "staffId", "wristbandNo" FROM "Visit";
DROP TABLE "Visit";
