...
INSERT INTO "new_Visit" ("amount", "checkInAt", "checkOutAt", "childId", "createdAt", "durationMin", "guardianId", "id", "paymentMethod", "paymentStatus", "pricingPlanId", "staffId", "wristbandNo") SELECT "amount", "checkInAt", "checkOutAt", "childId", "createdAt", "durationMin", "guardianId", "id", "paymentMethod", "paymentStatus", "pricingPlanId", "staffId", "wristbandNo" FROM "Visit";
DROP TABLE "Visit";
